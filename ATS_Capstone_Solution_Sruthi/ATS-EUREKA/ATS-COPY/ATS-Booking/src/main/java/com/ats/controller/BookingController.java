...
public class BookingController {
    ...
    public String updateBookingDetails(@RequestBody BookingModel bookingInfo) {
        try {
            ...
            if (bookingInfo.getDepartureDate() != null && !bookingInfo.getDepartureDate().isEmpty()) {
                bookingDetailsToBeUpdated.setDepartureDate(bookingInfo.getDepartureDate());
            }
            if (bookingInfo.getDepartureTime() != null&& !bookingInfo.getDepartureTime().isEmpty()) {
                bookingDetailsToBeUpdated.setDepartureTime(bookingInfo.getDepartureTime());
            }
            if (bookingInfo.getArrivalDate() != null&& !bookingInfo.getArrivalDate().isEmpty()) {
                bookingDetailsToBeUpdated.setArrivalDate(bookingInfo.getArrivalDate());
            }
            if (bookingInfo.getArrivalTime() != null&& !bookingInfo.getArrivalTime().isEmpty()) {
